...
# This is the kawpow install script.
echo "kawpow install script."
...
git clone https://github.com/hermangroup/kawpow-stratum-pool.git $(pwd)/kawpow
...
echo "Please resume installation at the kawpow Wiki: 
